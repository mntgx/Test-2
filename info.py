...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'mntgx')
...
FILE_CHANNELS = [int(ch) for ch in environ.get('FILE_CHANNELS', '-1002539291881 -1003832808667 -1003666359143 -1003854873222').split()]
...
LOCAL_CACHE_DIR = (environ.get('LOCAL_CACHE_DIR') or environ.get('TMPDIR') or '/tmp').rstrip('/') or '/tmp'
DISK_MEDIA_CACHE_PATH = environ.get('DISK_MEDIA_CACHE_PATH', f'{LOCAL_CACHE_DIR}/media_cache.sqlite3')
DISK_MEDIA_CACHE_MAX_BYTES = parse_size_to_bytes(environ.get('DISK_MEDIA_CACHE_MAX_SIZE', '1500MB'), 1500 * 1024**2)
DUP_SCAN_CACHE_DIR = environ.get('DUP_SCAN_CACHE_DIR', LOCAL_CACHE_DIR)
